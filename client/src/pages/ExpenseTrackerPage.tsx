    ...
    <Stack gap="lg">
                ...
                {transactions.map((transaction) => {
                  ...
                  return (
                    <Table.Tr key={transaction.id}>
                      ...
                      <Table.Td>
                        <Group gap="sm">
                          <Avatar size="sm" radius="xl" color={transaction.color}>
                            <Icon size={16} />
                          </Avatar>
                          <Text size="sm" fw={500}>
                      ...
                      <Table.Td>
                        <Badge size="sm" variant="light" color={transaction.color}>
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        ...
        <SimpleGrid cols={{ base: 1, sm: 3 }}>
          ...
          <Paper p="md" radius="md" style={{ backgroundColor: 'var(--mantine-color-teal-0)' }}>
            <Text size="sm" c="dimmed" mb={5}>
              순 저축
            </Text>
